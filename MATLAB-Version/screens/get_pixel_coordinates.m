...
function [pixel_coordinates] = get_pixel_coordinates(screen_lu_coordinates, scaling_vector_1, scaling_vector_2, image)
  ...
  image_y_dim = size(image)(1);
  image_x_dim = size(image)(2);
  ...
  pixel_coordinates = arrayfun(@(i, j) get_coordinates(i, j, scaling_vector_1, scaling_vector_2, size(image), screen_lu_coordinates), Y, X, 'UniformOutput', false);
endfunction