...
function [ray_out, ray_inside, t_in, t_out] = apply_lensing(ray_in, lens)
	...
	[intersection1, t_in] = get_intersection(ray_in, lens.equation);
	...
	dir_vector_inside = refraction(intersection1, ray_in(1) - ray_in(0), lens.n1, lens.n2, lens.equation, 1);
	...
	[intersection2, t_out] = get_intersection(ray_inside, lens.equation);
	...
	dir_vector_out = -refraction(intersection2, ray_inside(1) - ray_inside(0), lens.n2, lens.n1, lens.equation, 0);
